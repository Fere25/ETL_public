...
insert into deaise.voal_dwh_dim_accounts_hist ( account_num, valid_to, client, effective_from, effective_to, deleted_flg )
select 
	stg.account_num,
	stg.valid_to,
	stg.client,
...
from deaise.voal_stg_accounts stg
 	left join deaise.voal_dwh_dim_accounts_hist tgt
...
select 
	...
	'N' 
from deaise.voal_stg_accounts stg 
    inner join deaise.voal_dwh_dim_accounts_hist tgt
    on stg.account_num = tgt.account_num
...
update deaise.voal_dwh_dim_accounts_hist tgt 
...
select 
	...
	'Y' deleted_flg
from deaise.voal_dwh_dim_accounts_hist tgt 
