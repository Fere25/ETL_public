...
insert into deaise.voal_stg_cards_hist ( card_num, account_num, effective_from, effective_to, deleted_flg )
select 
	stg.card_num, 
	stg.account_num,
	stg.create_dt,
...
from deaise.voal_stg_cards stg
 	left join deaise.voal_stg_cards_hist tgt
...
select 
	...
	'N' 
from deaise.voal_stg_cards stg 
    inner join deaise.voal_stg_cards_hist tgt
    on stg.card_num = tgt.card_num
...
update deaise.voal_stg_cards_hist tgt 
...
from (
	...
	from deaise.voal_stg_cards stg inner join 
		 deaise.voal_stg_cards_hist tgt
	  on stg.card_num = tgt.card_num
	 and tgt.effective_to = to_date('9999-12-31','YYYY-MM-DD')
...
select 
	...
	'Y' deleted_flg
from deaise.voal_stg_cards_hist tgt 
